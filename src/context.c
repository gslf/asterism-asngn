...
static asngn_err context_check(asngn_ctx *c, int slot,
                               const asmodel_input *input, int output_reserve,
                               const asngn_prompt *zones, size_t extra_tokens) {
...
asngn_err asngn_context_validate(asngn_ctx *c, int count_slot,
  ...
  asmodel_text_input pair; asmodel_input_pair(&pair,prompt->system_text,prompt->user_text);
...
asngn_err asngn_context_validate_text(asngn_ctx *c, int count_slot,
                                      ...
                                      int output_reserve) {
  asmodel_text_input pair; asmodel_input_pair(&pair,system_text,user_text);
